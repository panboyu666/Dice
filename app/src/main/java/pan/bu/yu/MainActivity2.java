...
public class MainActivity2 extends AppCompatActivity {
    ...
    private GifImageView gif11,gif22,gif33,gif44,npcme;
    ...
    private void initialize() {
        ...
        int i = intent.getIntExtra("key10", 100);
        switch (i){
            case 1:
                npcme.setImageResource(npc1);
                break;
            case 2:
                npcme.setImageResource(np2);
                break;
            case 3:
                npcme.setImageResource(np3);
                break;
            case 4:
                npcme.setImageResource(np4);
                break;
            case 5:
                npcme.setImageResource(np5);
                break;
            case 6:
                npcme.setImageResource(np6);
                break;
            case 7:
                npcme.setImageResource(np7);
                break;
            case 8:
                npcme.setImageResource(np8);
                break;
            case 9:
                npcme.setImageResource(np9);
                break;
            case 10:
                npcme.setImageResource(np10);
                break;
            case 11:
                npcme.setImageResource(np11);
                break;
            case 12:
                npcme.setImageResource(np12);
                break;
    ...
    public void method(View view) {
        ...
        if(bet==0){
            Toast.makeText(this, "請押賭注",Toast.LENGTH_SHORT).show();
        }
        if(turnOn & bet!=0) {
